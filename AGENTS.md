...
This repo is a **brand OS** — the machine-consumable source of truth for the brand.

Start at the front door: **[BRAND.md](./BRAND.md)**. It names the brand, the
aesthetic posture, the logo/color/type system, the voice, and the path to every
usable asset.
